            ...
            <li>
                <select id="" class="filter_byx" name="filter_name">
                    <option value="1"><?php
                        ...
                        if ($nam == 2) {
                            echo "Number of Male Students";
                        } elseif ($nam == 3) {
                            echo "Number of Female Students";
                        } elseif ($nam == 4) {
                            echo "Famous program: Male";
                        } elseif ($nam == 5) {
                            echo "Least Famous Program:Male";
                        } elseif ($Nma == 6) {
                            echo "Famous Program:Female";
                        } elseif ($nam == 7) {
                            echo "Least Famous Program:Female";
                        } elseif ($nam == 8) {
                            echo "Full Time Graduates";
                        } elseif ($nam == 9) {
                            echo "Part Time Graduates";
                        } elseif ($nam == 10) {
                            echo "Full Time Under Graduates";
                        } elseif ($nam == 11) {
                            echo "Part Time Under Graduates";
                        } elseif ($nam == 12) {
                        ...
                        ?></option>
                    <option value="2">Number of Male Students</option>
                    <option value="3">Number of Female Students</option>
                    <option value="4">Famous Program: Male</option>
                    <option value="5">Least Famous Program: Male</option>
                    <option value="6">Famous Program:Female</option>
                    <option value="7">Least Famous Program:Female</option>
                    <option value="8">Full Time Graduates</option>
                    <option value="9">Part Time Graduates</option>
                    <option value="10">Full Time Under Graduates</option>
                    <option value="11">Part Time Under Graduates</option>

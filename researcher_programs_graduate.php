...
?>
    ...
    <form action="researcher_programs_graduate.php" method="post">
        <div class="card-title">Graduate Programs</div>
        <hr>
        <table>
            <tr>
                <th>Program</th>
...
INNER JOIN registration_system.program_graduate pg on e.programName = pg.programGraduateName 

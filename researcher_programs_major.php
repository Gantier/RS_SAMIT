...
?>
    ...
    <form action="researcher_programs_major.php" method="post">
        <div class="card-title">Major Programs</div>
        <hr>
        <table>
            <tr>
                <th>Program</th>
...
INNER JOIN registration_system.program_major pm on e.programName = pm.programMajorName 

<?php
    ...
    { //student advisers (sql to associative array)
        ...
        $resultStudentAdvisers = mysqli_fetch_all($conn->query($sqlStudentAdvisers), MYSQLI_ASSOC);//student enrollments
        ...
        $resultStudentEnrollments = mysqli_fetch_all($conn->query($sqlStudentEnrollments), MYSQLI_ASSOC);//student total credits
        ...
        $studentCredits = mysqli_fetch_row($resultStudentCredits);//student hold
        ...
        $studentHold = mysqli_fetch_row($resultStudentHold);//student semesters attended
    ...
    function studentSatisfiesPreReqsOfCourse($studentId, $dependentCourse)
    {

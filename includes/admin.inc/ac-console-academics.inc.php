    ...
    <div class="card" id="ac-academics-search-card">
        ...
        <div class="card-body">
            <form method="post" action="admin_academics_inner.php">
                ...
                <button style="display: none;" class="small-button outlined secondary" id="ac-academics-button"
                        name="add-account-submit"
                        type="submit">
                </button>

                <input style="display: none;" type="text" name="ac-academics-email-hidden"
                       id="ac-academics-email-hidden">

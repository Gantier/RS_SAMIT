<div id="ac-console-container">
    ...
    <div class="card" id="ac-course-edit-card">
        ...
        <div class="card-body">
            <form method="post" id="ac-add-course-form" action="includes/admin.inc/edit_course.inc.php">
                ...
                <div class="edit-course-modifying-title">
                    ...
                    <input class="form-text-field ac-name-text-box" id="ac-course-mod-title-text-box" type="text"
                           name="ac-edit-course-title" placeholder="Course Title..."><br><br><br>
                    <hr>
                    <br>
                </div>
                ...
                <div class="edit-course-description">
                    <textarea id="ac-course-desc-text-area" name="ac-course-desc" form="ac-add-course-form"
                ...
                <div class="edit-course-main">
                    <!--TITLE-->
                    <input class="form-text-field ac-name-text-box" id="ac-course-title-text-box" type="text"
                           name="ac-edit-course-new-title" placeholder="Course Title...">
                    <!--SUBJECT-->
                    <select name="ac-edit-course-subject" id="admin-edit-subject-dropdown">
                        <option value="null" selected hidden>Select subject...</option>
                        <?php
                            for ($i = 0; $i < sizeof(Constants::SUBJECTS); $i++)
                            {
                    ...
                    <!--ATTRIBUTE-->
                    <select name="ac-edit-course-attribute" id="ac-attribute-dropdown">
                        <option value="null" selected hidden>Select attribute...</option>
                        <?php
                            for ($i = 0; $i < sizeof(Constants::ATTRIBUTES); $i++)
                            {
                    ...
                    <!--NUMBER-->
                    <input class="form-text-field ac-name-text-box" id="ac-course-number-text-box" type="number"
                           name="ac-edit-course-number" min="1000" max="9999" placeholder="Course Number...">

                    <!--CREDITS-->
                    <input class="form-text-field ac-name-text-box" id="ac-course-credits-text-box" type="number"
                           name="ac-edit-course-credits" min="1" max="6" placeholder="Credits...">
    ...
    <div class="card" id="ac-admin-delete-card">
        ...
        <div class="card-body">
            <form method="post" action="includes/admin.inc/delete_course.inc.php">

                <div class="edit-course-modifying-title">
                    <!--TITLE-->
                    <input class="form-text-field ac-name-text-box" id="ac-course-mod-title-text-box" type="text"
                           name="ac-delete-course-title" placeholder="Course Title...">
                </div>

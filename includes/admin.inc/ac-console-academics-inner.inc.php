    ...
    <div class="card" id="ac-modify-grades-card">
        ...
        <div class="card-body">
            <form method="post" action="includes/admin.inc/update_grades.inc.php">
                ...
                <input style="display: none;" type="text" name="ac-academics-grades-email-hidden"
                       id="ac-academics-grade-email-hidden">
                ...
                <!--SUBMIT BUTTON-->
                <button class="small-button outlined secondary" id="ac-modify-grades-button"
                        name="ac-modify-grades-submit"
                        type="submit">Submit
                </button>

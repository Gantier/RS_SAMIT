<?php
    ...
    require "includes/constantsMatt.inc.php";
                ...
                case 'admin':
                    {
                        ...
                        echo '"><a href="javascript:void(0)" class="drop-button">Accounts</a>';
                        echo '<div class="dropdown-content">';
                        echo '<a class="dropdown-anchor';
                        if (preg_match("[admin_accounts_student]", $current_page))
                        {
                            echo ' nav-bar-active';
                        }
                        echo '" href="admin_accounts_student.php">Students</a>';
                        echo '<a class="dropdown-anchor';
                        if (preg_match("[admin_accounts_faculty]", $current_page))
                        {
                            echo ' nav-bar-active';
                        }
                        ...
                        echo '" href="admin_accounts_researcher.php">Researcher</a>';
                        echo '<a class="dropdown-anchor';
                        if (preg_match("[admin_accounts_admin]", $current_page))
                        {
                            echo ' nav-bar-active';
                        }
                        echo '" href="admin_accounts_admin.php">Admin</a></div></li>';

...
?>
    ...
    <form action="researcher_courses_undergraduate.php" method="post">
        <div class="card-title">Courses For Undergraduates</div>
        <hr>
        <table>
            <tr>
                <th>Program</th>
...
INNER JOIN registration_system.course_undergraduate cg on cg.courseUndergraduateName = sec.sectionCourse 

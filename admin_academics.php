...
//require "add_account.inc.php";
    ...
    viewFancyTableFromSQL($conn, $sqlAdminAccounts, $current_page, "adaccounts-table-container", "ac-table", "Student Accounts", "academicsClick(this)");

    require "includes/admin.inc/ac-console-academics.inc.php";
